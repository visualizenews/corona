...
- template: chart
  ...
  introduction: |-
    ...
    After the peak, the number of hospitalizations is plateauing and, finally, between the April 11 and 13 the number of people who have recovered has crossed the one still hospitalized.
  explanation: ''
- template: chart
  show_title: true
  appearance: Centered
