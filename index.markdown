...
- template: chart
  ...
  introduction: |-
    ...
    After the peak, the number of hospitalizations is plateauing and, finally, since April 12 the number of people who have recovered has crossed the one still hospitalized.
  explanation: ''
- template: chart
  show_title: true
  appearance: Centered
