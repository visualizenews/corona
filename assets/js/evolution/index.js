evolution = (data, id) => {
    ...
    const reset = () => {
        ...
        container
            ...
            .html(`${d3LocaleFormat.format(numberFormat.no_decimals)(chartData[chartData.length - 1].y)} active cases<br />in Italy on <span>${moment(chartData[chartData.length - 1].x).format('MMM DD')}</span>`)
    }
