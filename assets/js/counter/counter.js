counter = (data, id) => {
    ...
    let html = `<div class="counter">
        ...
        <p class="counter-text">of which, <strong>${d3.format('.2s')(lombardy)}</strong> in Lombardy alone. This means 1 test every <strong>${d3.format('.2s')(ratio)}</strong> italians.</p>
    </div>`;
