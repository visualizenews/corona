 ...
 * @returns {Array.<Point>}
 */
const intersectsPath = function(svgPath, path, segmentLength){
    ...
    for(var i = 0; i < numberOfSegments; i++){
        ...
        var segmentStart   = svgPath.getPointAtLength(i * stepLength),
            segmentEnd     = svgPath.getPointAtLength((i + 1) * stepLength),
            lineSegmentPos = {
                x1: segmentStart.x,
                y1: segmentStart.y,
                x2: segmentEnd.x,
...
function path_linePos(pathEl, linePos, segmentLength){
    ...
    for(var i = 0; i < numberOfSegments; i++){
        ...
        var segmentStart   = pathEl.getPointAtLength(i * stepLength),
            segmentEnd     = pathEl.getPointAtLength((i + 1) * stepLength),
            lineSegmentPos = {
                x1: segmentStart.x,
                y1: segmentStart.y,
                x2: segmentEnd.x,
